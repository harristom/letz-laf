...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        //         The LëtzLaf Marathon, known for its scenic routes and spirited atmosphere, showcased the picturesque beauty of Luxembourg, drawing both seasoned athletes and amateur runners eager to challenge themselves against the backdrop of the city's stunning landscapes. Participants embraced the challenge with fervor, ranging from the 5K fun run to the grueling 42-kilometer marathon, showcasing the inclusivity of this sporting extravaganza.
        //         The winners of the various categories were celebrated amidst roaring applause, but the true spirit of the LëtzLaf Marathon was the camaraderie and personal triumphs achieved by every participant who crossed the finish line.",
        //         'image_path' => 'luxembourg.png',
        //     ],
        //     [
        //         'user_id' => $user->id,
        ...
        //         Participants embraced the challenge across various categories, from the moderate 10K to the demanding 30K trail run, showcasing their endurance and love for nature. The LëtzLaf Trail Run, organized by LëtzLaf Sports Association, aimed to promote both physical fitness and an appreciation for Luxembourg's stunning terrain.
        //         Runners navigated through challenging terrains, encountering steep ascents and thrilling descents, all while being surrounded by the breathtaking beauty of the Luxembourgish countryside. The event not only tested their physical prowess but also offered a unique opportunity to connect with nature.
        //         Participants emerged from the trails with a sense of accomplishment, having conquered the demanding course and experienced the thrill of trail running amidst such awe-inspiring scenery.
